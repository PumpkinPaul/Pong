...
public static class KeyboardUtils
{
    ...
    private static readonly Dictionary<Keys, char> ChatPadGreenKeyMap = new Dictionary<Keys, char>();
    private static readonly Dictionary<Keys, char> ChatPadOrangeKeyMap = new Dictionary<Keys, char>();
