...
public static class DebugSystem
{
    ...
    public static readonly Vector2 SmallGaugeSize = new Vector2(16, 48);
    public static readonly Vector2 MediumPlotSize = new Vector2(64, 48);
    public static readonly Vector2 LargePlotSize = new Vector2(128, 48);
